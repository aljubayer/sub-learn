...
if ( ! function_exists( 'codexin_enqueue' ) ) {
    ...
    function codexin_enqueue() {
        ...
        wp_enqueue_style( 'materialize', trailingslashit( get_template_directory_uri() ) . 'assets/vendor/materialize/css/materialize.css', array(), '1.0.0', 'all');
 ...
 *
 */
require_once trailingslashit( get_template_directory() ) . 'inc/libs/menus.php';
require_once trailingslashit( get_template_directory() ) . 'inc/libs/paginations.php';